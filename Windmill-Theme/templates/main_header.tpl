        ...
        -->
            ...
            <li class="relative px-6 py-3">
              <form method="post" action="" style="padding:5px 8px 0 0;margin:0;">
                <select name="newlang" style="padding:0;margin:0;" onchange="this.form.submit()" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
...
<main class="h-full overflow-y-auto">
  ...
  >
  	<div class="flex items-center">{$title|lang}{if $title2} - {$title2|lang}{/if}</div>
